...
//            mActiveDotColor = a.getColor(R.styleable.DottedProgressBar_activeDotColor, Color.BLUE);
            ...
            a.getValue(R.styleable.DotProgressBar_activeDot, value);
            ...
            a.getValue(R.styleable.DotProgressBar_inactiveDot, value);
            if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT && value.type <= TypedValue.TYPE_LAST_COLOR_INT) {
                // It's a color
            ...
            mDotSize = a.getDimensionPixelSize(R.styleable.DotProgressBar_dotSize, 5);
            mSpacing = a.getDimensionPixelSize(R.styleable.DotProgressBar_spacing, 10);

            mActiveDotIndex = a.getInteger(R.styleable.DotProgressBar_activeDotIndex, 0);

            mJumpingSpeed = a.getInt(R.styleable.DotProgressBar_jumpingSpeed, 500);
